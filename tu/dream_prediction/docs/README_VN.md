...
- `models/scaler_vn.pkl` - Scaler đã fit
- `models/ten_dac_trung_vn.pkl` - Tên các đặc trưng
- `reports/figures/ma_tran_tuong_quan.png` - Ma trận tương quan
- `reports/figures/phan_tich_dac_trung.png` - Phân tích đặc trưng
- `reports/figures/phan_tich_toan_dien.png` - Biểu đồ tổng hợp
