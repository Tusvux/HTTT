...
5. Chạy lại `python src/load_real_data.py`
...
- Lưu vào file `data/dream_data.csv`
...
Chạy predict_vn.py chế độ 2 và nhập đường dẫn file.
