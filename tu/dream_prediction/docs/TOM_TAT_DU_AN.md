...
#### 1. **Dữ liệu (Data)**
- ✅ `data/dream_data_vn.csv` - Dữ liệu tiếng Việt với các cột:
  - `tuoi` - Tuổi
  - `gio_ngu` - Giờ ngủ
...
- ✅ `reports/figures/ma_tran_tuong_quan.png` - Ma trận tương quan features
- ✅ `reports/figures/phan_tich_dac_trung.png` - F-score và Mutual Information
- ✅ `reports/figures/phan_tich_toan_dien.png` - Phân tích toàn diện với 9 biểu đồ:
  - Confusion Matrix
  - Feature Importance
...
#### 5. **Models đã lưu**
- ✅ `models/mo_hinh_tot_nhat_vn.pkl` - Mô hình tốt nhất (thường là SVM hoặc Ensemble)
- ✅ `models/scaler_vn.pkl` - Scaler đã fit (RobustScaler)
...
```
**Output:**
- Mô hình tốt nhất: `models/mo_hinh_tot_nhat_vn.pkl`
- Scaler: `models/scaler_vn.pkl`
- Dữ liệu tiếng Việt: `data/dream_data_vn.csv`
- Các biểu đồ phân tích trong `reports/figures/`
